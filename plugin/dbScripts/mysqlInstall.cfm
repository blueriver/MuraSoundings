<cfoutput>
DROP TABLE IF EXISTS `sp#variables.config.getPluginID()#_answers`;
CREATE TABLE `sp#variables.config.getPluginID()#_answers` (
...
DROP TABLE IF EXISTS `sp#variables.config.getPluginID()#_questions`;
CREATE TABLE `sp#variables.config.getPluginID()#_questions` (
  `id` varchar(35) NOT NULL,
...
DROP TABLE IF EXISTS `sp#variables.config.getPluginID()#_questiontypes`;
CREATE TABLE `sp#variables.config.getPluginID()#_questiontypes` (
  `id` varchar(35) NOT NULL,
...
DROP TABLE IF EXISTS `sp#variables.config.getPluginID()#_results`;
CREATE TABLE `sp#variables.config.getPluginID()#_results` (
...
DROP TABLE IF EXISTS `sp#variables.config.getPluginID()#_survey_emailaddresses`;
CREATE TABLE `sp#variables.config.getPluginID()#_survey_emailaddresses` (
  `surveyidfk` varchar(35) NOT NULL,
...
DROP TABLE IF EXISTS `sp#variables.config.getPluginID()#_survey_results`;
CREATE TABLE `sp#variables.config.getPluginID()#_survey_results` (
  `surveyidfk` varchar(35) NOT NULL,
...
CREATE TABLE `sp#variables.config.getPluginID()#_surveys` (
  `id` varchar(35) NOT NULL,
  `name` varchar(50) NOT NULL,
  ...
  `resultmailto` varchar(50) default NULL,
...
CREATE TABLE `sp#variables.config.getPluginID()#_templates` (
...
CREATE TABLE `sp#variables.config.getPluginID()#_users` (
...
INSERT INTO sp#variables.config.getPluginID()#_questiontypes(id, name, handlerroot)
